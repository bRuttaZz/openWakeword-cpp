 ...
 * @param wwd_model_path - wakeword detection onnx model path.
 ...
 */
int wait_wakeword_from_mic(float threshold, const char* wwd_model_path, const char* embedding_model_path, const char* melspectrogram_model_path);
 ...
 */
int wait_wakeword_from_file(FILE* file, float threshold, const char* wwd_model_path, const char* embedding_model_path, const char* melspectrogram_model_path);
